...
ANTSSCRIPTNAME=${ANTSPATH}/antsIntroductionRegularizedJohnTEST.sh
...
#		echo " submitting job number $count " # for debugging only
  ...
  updatetotemplate ${DIM} ${TEMPLATE} ${TEMPLATENAME} ${OUTPUTNAME} ${GRADIENTSTEP}
