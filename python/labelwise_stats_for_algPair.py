...
data_file = '{}/label_data_line{}.csv'.format( base_dir, line )
...
for alg1,alg2 in itertools.combinations( alg_list.split(' '), 2 ):
    ...
    out_file = '{}/algStatsByLabel/{}_vs_{}_line{}.csv'.format( base_dir, alg1, alg2, line )
    print( 'out data file: ', out_file )

    df_alg1 = dist_samples_df[ (dist_samples_df.ALG == alg1) ]
    df_alg2 = dist_samples_df[ (dist_samples_df.ALG == alg2) ]
