...
public class CalibratedRai3d<T extends RealType<T> & NativeType<T>>
{ 
	...
	public CalibratedRai3d( ImagePlus imp, T t )
	{
		this( ImageJFunctions.wrap( imp ), resolutions(imp) );
	}

	public CalibratedRai3d( RandomAccessibleInterval<T> img, double[] resolutions )
	{
		scaleXfm = getScaleXfm( resolutions );
		this.img = img;
